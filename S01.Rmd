...
+ Checking data sets: Quick summaries
  - Mean, median, quantile, standard deviation, variance, outliner  
...
Check this [cheat sheet](https://raw.githubusercontent.com/rstudio/cheatsheets/master/rstudio-ide.pdf) (need VPN) for more features and shortcuts of the RStudio IDE.
