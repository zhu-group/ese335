...
Load rivers data sets (length of `141` rivers in North America) 
...
Load `beaver1` and `beaver2` data sets (body temperature data of 2 beavers every 10 minutes) 

**3.1 [5 points]** Visualize these two data sets in multiple ways
