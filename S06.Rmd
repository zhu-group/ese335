...
In this case, $Estimate$ is the sample average ($\overline{X}$), and $Parameter$ is the population mean ($\mu$). Since the sample is from a normal population with a known ($\sigma$), the SD of the sample average ($\overline{X}$) is then $\ {\sigma} / {\sqrt{n}}$, here $n$ is the sample size. 
