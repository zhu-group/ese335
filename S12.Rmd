...
Here we introduce the *Tukey's Test* (or Tukey procedure), also called Tukey’s Honest Significant Difference (Tukey's HSD) test, which is based on the studentized range distribution. 

Let's use the [Cd example from the last section](https://zhu-group.github.io/ese335/S11.html#Section_Example:_Removal_of_cadmium_from_soil_by_plants) for the one-way ANOVA and its Tukey's test.
