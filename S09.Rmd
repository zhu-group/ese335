...
The paired-sample t-test is the same as the [one-sample t-test](https://zhu-group.github.io/ese335/S07.html#One_sample_t-test) as the difference ($D$) between the two populations ($X_1$ and $X_2$) is tested against zero.
...
A general way to write the CI ($100(1-x)%$ confidence level) of the unknown population mean ($\mu_D$) would be:
