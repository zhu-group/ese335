...
Recall the [Exercise #2](https://zhu-group.github.io/ese335/S08.html#Exercise_2) from Section 08, compute the `90%`, `95%`, and `99%` CI for the difference between mean COD from the two rivers. Can you explain why CI is wider for a higher confidence level?