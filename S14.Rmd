---
title: "Section 14 Non-parametric tests"
output:
  html_document:
    toc: true
    toc_float:
...
# Section example: Soil organic matter content

Given the following organic matter contents (unit: %) in different soil types, do organic matters differ in different soil types?
...
+ The underlying distribution is **not normal**, thus the normality assumption is not met
...
The requirements of using Mann–Whitney U test is:

+ Random and independent samples

+ For maximum accuracy, there should be no ties. But there is a way to handle ties

In the Mann–Whitney U test, we have:

+ H0: There is no difference in the two population

+ H1: There is a difference in the two population
...
The requirements of using the Wilcoxon signed rank test is:
...
+ H0: There is no difference in the two populations

+ H1: There is a difference in the two populations
...
+ H0: There is no difference among populations

+ H1: There is a difference among populations
...
|:----:|:--------:|:-------------:|
|Checking independence | | [Runs test](https://zhu-group.github.io/ese335/S10.html#Independence)|
|Checking normality |    | [Shapiro-Wilk test](https://zhu-group.github.io/ese335/S06.html#Shapiro-Wilk_test), [Lillifors test](https://zhu-group.github.io/ese335/S06.html#Lilliefors_test)|
|Checking Outliers | [Grubbs’ test](https://zhu-group.github.io/ese335/S10.html#Grubbs%E2%80%99_test), [Dixon’s test](https://zhu-group.github.io/ese335/S10.html#Dixon%E2%80%99s_test), [Rosner’s test](https://zhu-group.github.io/ese335/S10.html#Rosner%E2%80%99s_test) | [Walsh’s test](https://zhu-group.github.io/ese335/S10.html#Walsh%E2%80%99s_test) |
|Comparing means of two independent populations  | [t test](https://zhu-group.github.io/ese335/S08.html#Independent_two-sample_t-test_with_R)   | Mann-Whitney U test |
|Comparing means of two paired populations  | [paired t test](https://zhu-group.github.io/ese335/S09.html#Paired_sample_t-test_with_R)   | Wilcoxon signed rank, Signed test |
|Comparing means of more than 3 independent populations  | [One-way ANOVA](https://zhu-group.github.io/ese335/S11.html#One-way_ANOVA_with_R) | Kruskal–Wallis test |
|Checking correlation  | [Pearson test](https://zhu-group.github.io/ese335/S13.html#Pearson_correlation_test_procedure)  | Spearman test, Kendall test|
...
Do the observations support the hypothesis? Report your results.

## Exercise #2

Using data from the section example, do organic matters differ in different soil types? Report your results.
...
Does aerosol surface density relate to Pb content? Report your results.
