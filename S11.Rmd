...
Here we convert `cd_data` to `cd_data_tbl`, which has a new format `tibble`. See [Section 02 Data wrangling and quick plots](https://zhu-group.github.io/ese335/S02.htmll) for more.
