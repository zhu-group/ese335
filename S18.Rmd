...
Consider the global temperature series record (`globtemp`) in the `astsa` package. The data are the global mean land and ocean temperature index from `1880` to `2015`, with the base period 1951-1980. We want to fit an ARIMA model to this time series.
