---
title: "Section 05 Data wrangling and quick plots"
output:
  html_document:
    toc: true
    toc_float:
...
# Section Example: weather data at the BaoAn airport

Environment data, expecially raw observations, are really messy. Here we  take a look at the hourly weather data measured at the BaoAn International Airport during the past 10 years. The data set is download from [NOAA Integrated Surface Dataset](https://www.ncei.noaa.gov/metadata/geoportal/rest/metadata/item/gov.noaa.ncdc%3AC00532/html).
...
As you will see, this is much easier than what we have done in [Section 1](https://zhu-group.github.io/ese335/S02.html#Loading_a_csv_file). This is the power of a tidy dataset and its related functions!
...
Give the following observations, draw two boxplots (with and without outliers):

`1, 1, 6, 13, 13, 14, 14, 14, 16, 17, 18, 18, 19, 19, 20, 21, 22`.

Then make a boxplot with R, compare it with your hand-drawing boxplots.
