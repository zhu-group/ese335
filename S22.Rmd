---
title: "Section 22 Making websites with R Markdown"
output:
  html_document:
    toc: true
    toc_float:
...
+ Open GitKraken, make a new repository `web_test` by clicking `Start a hosted repo`, then fill the information, and save this repository locally (e.g., `D://web_test/`).

+ Download [this demo](https://zhu-group.github.io/ese335/download/web_demo.zip), decompress it, and copy all items (including files and folders) to the local repository folder `web_test`.
...
See `Page1.Rmd` for basic syntax in R Markdown. More are available at this [R Markdown cheat sheet](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf).  
...
* [Source code for ESE335](https://github.com/zhu-group/ese335)

* [Version control with Git](https://zhu-group.github.io/ese5023/Section_02.html)
