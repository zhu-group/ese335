...
You can check the above themes at this [gallery](https://rmarkdown.rstudio.com/gallery.html). Pass null for no theme (in this case, you can use the `css` parameter to add your own styles). 
